 ...
 */
export type EventPayload = ViewedPagePayload | ViewedSamplePinPayload | ChangedThemePayload | SelectedDatePayload | ZoomedMapPayload | PannedMapPayload | FailedLoadingDataPayload | ErrorOccurredPayload;
/**
...
/**
 * Type for event descriptions mapping
 */
export type EventDescriptionMap = Record<AnalyticsEvent, string>;
/**
