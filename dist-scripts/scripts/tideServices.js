...
import { isTideReading, isNOAAStationsResponse, isNOAAWaterLevelResponse } from '../src/types/tide';
 ...
 */
export async function getTideData(stationId, sampleTime) {
  try {
 ...
 */
export function determineTideStatus(tideData, sampleDate) {
