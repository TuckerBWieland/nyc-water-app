 ...
 * @param {string|number} mpn - MPN value to evaluate
 * @param {number} [lowThreshold] - Good water quality threshold
 * @param {number} [mediumThreshold] - Moderate water quality threshold
 * @returns {string} Water quality rating
 */
 ...
 * @param {number} [lowThreshold] - Good water quality threshold
 * @param {number} [mediumThreshold] - Moderate water quality threshold
 * @returns {string} Hex color code for the water quality
 */
 ...
 * @param {number} [lowThreshold] - Good water quality threshold
 * @param {number} [mediumThreshold] - Moderate water quality threshold
 * @returns {string} Descriptive message for the water quality
 */
 ...
 * @param {number} [lowThreshold] - Good water quality threshold
 * @param {number} [mediumThreshold] - Moderate water quality threshold
 * @returns {string} CSS class for the water quality
 */
 ...
 * @param {Object} map - Leaflet map instance ref
 * @param {Object} [options] - Marker customization options
 * @param {boolean} [options.trackAnalytics=true] - Whether to track marker interactions in analytics
 * @param {boolean} [options.isDarkMode=false] - Whether markers use dark mode styling
 * @param {number} [options.lowThreshold] - Customized threshold for low MPN
 * @param {number} [options.mediumThreshold] - Customized threshold for medium MPN
 * @returns {Object} Object with marker management functions
 */
export function useMarkers(map, options = {}) {
  ...
  const createPopupContent = (feature) => {
    ...
    if (tideSummary) {
      ...
      if (tideSummaryStr.includes('Low Tide   Falling')) {
      ...
      } else if (tideSummaryStr.includes('High Tide   Rising')) {
        const stationInfo = tideSummaryStr.includes('(')
          ? tideSummaryStr.substring(tideSummaryStr.indexOf('('))
          : '';
   ...
   * @returns {Object|null} Leaflet featureGroup containing all markers
   */
